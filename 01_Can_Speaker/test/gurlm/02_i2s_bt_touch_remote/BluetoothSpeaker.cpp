...
static const char *deviceName = "CAN Speaker$$";

static bool _init_bt()
{
    
    Serial.println("_init_bt start ");
  ////////////////////////////////////////////////////////////
...
static void bt_av_hdl_stack_evt(uint16_t event, void *p_param)
{
    ...
    case BT_APP_EVT_STACK_UP: {
        /* set up device name */
        Serial.println("bt_av_hdl_stack_evt 0");
        //char *dev_name = "ESP_SP";
        esp_bt_dev_set_device_name(deviceName);
    ...
    default:
        Serial.println("bt_av_hdl_stack_evt 1");
        break;
    }
}
...
bool BluetoothSpeaker::begin(void)
{
    /*if (localName.length()){
